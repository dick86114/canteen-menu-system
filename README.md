...
- 📁 **自动文件扫描** - 系统启动时自动扫描 `menu` 目录下的Excel或et文件
- 🔄 **一键刷新** - 点击"刷新菜单"按钮重新扫描文件
- 📂 **无需手动上传** - 将Excel或et文件放入 `menu` 目录即可自动加载
- 📅 日期导航和菜单查看
- 📱 响应式设计，支持移动设备
- 🎨 现代化UI设计
- 🌐 中文界面支持
...
### 桌面端视图
- **日期导航** - 直观的日期选择器,支持前后日期切换
![alt text](/img/image.png)
- **月历视图** - 点击日期打开月历,快速选择任意日期
...
- **手势支持** - 左右滑动切换日期
- **底部弹出** - 月历选择器从底部弹出,符合移动端操作习惯
- **暗黑模式** - 自动适配系统暗黑模式,保护视力
![alt text](/img/image-4.png)

## 使用方法

### 方式一：自动扫描（推荐）
1. 将Excel或et菜单文件放入项目根目录的 `menu` 文件夹
